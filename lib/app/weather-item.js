 ...
 */
var getWeatherItem = function getWeatherItem(id, favorited, city, country, localTime, observationTime, utcOffset, temperature, scale, iconUrl, descriptions, windSpeed, windDirection, pressure, precipitation, humidity, cloudCover, feelsLike, uvIndex, visibility, lat, long) {
  return {
    id: id,
    favorited: favorited,
    city: city,
...
exports.getWeatherItem = getWeatherItem;